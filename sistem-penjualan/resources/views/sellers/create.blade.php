...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="fas fa-user-plus"></i> Tambah Seller</h2>
    ...
    <div class="card-body">
        <form action="{{ route('sellers.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama_seller') is-invalid @enderror" id="nama_seller" name="nama_seller" value="{{ old('nama_seller') }}" required>
                @error('nama_seller')
