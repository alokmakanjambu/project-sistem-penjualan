...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="{{ auth()->check() ? (auth()->user()->role === 'admin' ? route('admin.dashboard') : route('dashboard')) : url('/') }}">
                        ...
                        @if(auth()->user()->isAdmin())
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('sellers.index') }}">
                                    <i class="fas fa-users"></i> Seller
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('buyers.index') }}">
                                    <i class="fas fa-user-friends"></i> Buyer
                                </a>
                            </li>
                        @endif
                        <li class="nav-item">
